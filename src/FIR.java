...
public class FIR extends JFrame implements MouseListener {
    ...
    public void paint(Graphics g) {
        ...
        g1.setColor(new Color(249, 214, 91));
        ...
        g1.drawString("游戏提示:" + message, 50, 50);

        g1.drawRect(30, 440, 180, 40);
        g1.drawRect(250, 440, 180, 40);   //画黑方时间与白方时间字符串的边框
        g1.setFont(new Font("宋体", Font.PLAIN, 12));
        ...
        if (e.getX() >= 430 && e.getX() <= (428 + 55) && e.getY() >= 286
            ...
            if (result == 0) {
                JOptionPane.showMessageDialog(this,
                        "游戏结束," + (isblack ? "黑方认输，白方获胜!" : "白方认输，黑方获胜!"));
            }
        }
    ...
    public boolean isWin() {
        boolean flag = false;
        int count;  //用来保存共有相同颜色多少棋子相连，初始值为1
